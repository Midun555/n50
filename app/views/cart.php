    ...
    <?php if ( $this->data['items'] ) : ?>
        ...
        <form action="/cart/update_items/" method="post">
            ...
            <div class="row hidden-xs">
                <div class="col-xs-2"><h4><strong>Product</strong></h4></div>
                <div class="col-xs-5">&nbsp;</div>
                <div class="col-xs-1 text-center"><h4><strong>Price</strong></h4></div>
                <div class="col-xs-2 text-center"><h4><strong>Quantity</strong></h4></div>
                <div class="col-xs-1 text-center"><h4><strong>Subtotal</strong></h4></div>
            ...
            <?php foreach ( $this->data['items'] as $product ) : ?>
                <div class="row n50-top-buffer-md">
                    ...
                    <div class="col-xs-2 text-center">
                        <input type="number" name="quantity[<?php echo $product['id'] ?>]" value="<?php echo $product['quantity'] ?>" min="0" class="text-center">
                    </div>
                    <div class="col-xs-1 text-center">
